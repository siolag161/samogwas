/****************************************************************************************
 * File: statistics.hpp
 * Description: This provides the common interface for all the available templated association tests
 * -----------  Fisher exact test, ChiSquared (with and without correction), G2 (with and without correction)
