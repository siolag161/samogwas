...
//---------------------------------------------------------------------------------------------------------------------
  std::string OptionPrinter::usage()
  {
    ...
    usageDesc << "[";
    for (std::vector<samogwas::CustomOptionDescription>::iterator it = options_.begin();
         it != options_.end();
         ++it)
    {
    ...
    /** positional option
     */
    for (std::vector<samogwas::CustomOptionDescription>::iterator it = positionalOptions_.begin();
...
//---------------------------------------------------------------------------------------------------------------------
  ...
  {
    samogwas::OptionPrinter optionPrinter;
    ...
    for (Options::iterator it = allOptions.begin();
         ...
         ++it)
    {
      samogwas::CustomOptionDescription currOption(*it);
      if ( positionalDesc )
      {
