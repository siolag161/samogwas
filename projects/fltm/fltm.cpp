...
AlgoClustering* getAlgoClust( FLTM_Data& input, Options& opt );
...
int main(int argc, char** argv) {
  ...
  AlgoClustering* algoClust = getAlgoClust( fltm_data, pos );
  FLTM_Result result;
  LinearCardinality emLC(pos.fltm_alpha, pos.fltm_beta, pos.fltm_maxCard);
  MultiEM *multiEM = new MultiEM( pos.fltm_nbrRestarts, pos.fltm_imputeMode );    
