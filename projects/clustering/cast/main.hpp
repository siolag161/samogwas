...
// void saveClustering( const samogwas::CAST_Partition& clustering, const std::vector<unsigned>& ids, std::string clustFN ) ;
// // void saveStatistics( const samogwas::CAST_Partition& clustering, const double score, const double elapsedTime, std::string statisticFN );
// ////////////////////////////// RANGE_ITERATOR ///////////////////////////////////////////
