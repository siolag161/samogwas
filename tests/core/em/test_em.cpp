...
//   std::cout  << "ca-vang-vang" << std::endld;
...
//     Variable latentVar = createLatentVar(q boost::num_vertices(graph), 3 );
//     samogwas::ResultEM resultEM;
//     samogwas::NaiveBayesEM multiEM(wrqwrqwwr3,1);
//     multiEM( resultEM, latentVar, vars, emMat, 0.000001 );

//     std::cout << resultEM.jointDistribution();
//     break;
